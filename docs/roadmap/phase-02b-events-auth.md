...
| **P02b-8** | `LS0002`, the carrier reconciliations this phase owes, the branch-protection edit that makes the behavioural check gate, and the exit checks | G16, G18 (the erasure inventory) Accepted |
