...
| 06 | [Testing](06-testing.md) | **Active** | Unit, integration, architecture and contract suites all run in CI, and the meta-test proves the architecture suite can fail. |
