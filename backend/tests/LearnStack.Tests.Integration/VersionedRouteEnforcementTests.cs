...
public sealed class DisagreeingPrefixProbeController : ControllerBase, ITestOnlyController
{
    [HttpGet]
    public IActionResult Get() => Ok();
}
...
public sealed class AgreeingPrefixProbeController : ControllerBase, ITestOnlyController
{
    [HttpGet]
    public IActionResult Get() => Ok();
}
